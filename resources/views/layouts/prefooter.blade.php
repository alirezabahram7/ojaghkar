<div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-sm-offset-3 text-center">
                    ...
                    <a class="munu2-footer" href="/">صفحه اصلی</a>
                    <a class="munu2-footer" href="#">درباره ما</a>
                    <a class="munu2-footer" href="#">تماس با ما</a>
                    <a class="munu2-footer" href="#">قوانین و مقررات</a>
                    <a class="munu2-footer" href="#">سوالات متداول</a>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4">
                    <h2 class="footer-text2">شبکه‌های اجتماعی</h2><br>
                    <p class="footer-text2"><ul class="social-menu text-right x-left">
                ...
                <div class="col-xs-12 col-sm-4">
                    <h2 class="footer-text2">تماس با ما</h2>
                    <br>
                    <p class="footer-text2">آدرس : تهران، جنب آباد جنوبی، خیابان پژوهنده، پلاک 45</p><br>
