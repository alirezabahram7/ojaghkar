            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4">
                    <div class="box">
                        ...
                        <p>نصب و تعمیر اجاق گاز رومیزی، صفحه‌ای، لمسی و زمینی تعمیر اجاق گاز فردار و بدون فر تعمیر و تعویض چینی فندک، کلید فندک، ترانس، بوبین، ترموکوپل اجاق گاز تعویض ولوم، سرشعله، فنجونی و شیشه اجاق گاز تعمیر فر گاز اجاقی، دیواری، ریلی، پیتزا پز، صنعتی تعمیر انواع برندهای تکنوگاز، لوفرا، لاجرمانیا، فلیم، گلیم، آرستون، بوش، آ ا گ، نف، زانوسی، ایندزیت، فریجیدر، زیمنس، ماژیک شف، کالریک، تاکنوگاز، آلتون، سینجر، پادیسان و کلیه برندهای ایرانی، اروپایی و آمریکایی.</p>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-4">
                    <div class="box">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4">
                    <div class="box">
                        ...
                        <p>تعمیر انواع لباسشویی ایرانی و خارجی سرویس ماشین لباسشویی دوقلو، سطلی و در از جلو راه اندازی و نصب انواع ماشین لباسشویی تعمیر موتور ماشین لباسشویی عیب یابی و رفع مشکل لباسشویی تعمیر انواع برندهای لباسشویی تکنوگاز، آاگ، بوش، جنرال الکتریک، ال جی، ارج، زانوسی، ایدزیت و کلیه برندهای ایرانی و خارجی</p>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="images/Onsite_Appliances.png" alt="">
                        </div>
                        <h4>تعمیر ماشین ظرفشویی</h4>
                        <p>تعمیر انواع ماشین ظرفشویی تعمیر ماشین ظرفشویی رومیزی و ایستاده راه اندازی و نصب ماشین ظرفشویی های مختلف تعمیر موتور ظرفشویی و تعمیر مخزن رزین عیب یابی و رفع مشکل ظرفشویی سرویس کامل ظرفشویی تعمیر انواع برندهای ظرفشویی  تکنوگاز، آاگ، بوش، جنرال الکتریک، ال جی، ارج، زانوسی، ایدزیت و کلیه برندهای ایرانی و خارجی</p>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="images/fridge-repair.jpg" alt="">
                        </div>
                        <h4>تعمیر یخچال فریزر</h4>
                        <p>تعمیر یخچال فریزر تعمیر یخچال ساید‌بای‌ساید تعمیر یخچال فروشگاهی تعمیر یخچال صندوقی تعمیر موتور یخچال شارژ گاز یخچال تعمیر انوع برندهای تکنوگاز، آاگ، بوش، جنرال الکتریک، ال جی، ارج، زانوسی، ایدزیت و کلیه برندهای ایرانی و خارجی </p>
                    </div>
                </div>
            </div>
        </div>
...
<h3>قیمت عادلانه و مناسب</h3>
    ...
    <section class="section-padding gray-bg" id="blog-page">
       <div class="panjah"><img src="images/servicesMain.png" style="height:100%;" alt=""/></div>
